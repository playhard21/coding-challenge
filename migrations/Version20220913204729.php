...
final class Version20220913204729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logs (id INT AUTO_INCREMENT NOT NULL, date_id_id INT NOT NULL, request_id_id INT NOT NULL, service_names VARCHAR(255) NOT NULL, status_code INT NOT NULL, UNIQUE INDEX UNIQ_F08FC65CC5B476DB (date_id_id), UNIQUE INDEX UNIQ_F08FC65C22532272 (request_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE logs ADD CONSTRAINT FK_F08FC65CC5B476DB FOREIGN KEY (date_id_id) REFERENCES log_dates (id)');
        $this->addSql('ALTER TABLE logs ADD CONSTRAINT FK_F08FC65C22532272 FOREIGN KEY (request_id_id) REFERENCES log_request (id)');
    }
